...
export const Settings: React.FC = () => {
  ...
  const colorSchemes = [
    ...
    { id: 'green', name: 'Teal & Mint', primary: 'bg-teal-500', secondary: 'bg-emerald-200' },
    { id: 'purple', name: 'Teal & Mint', primary: 'bg-teal-500', secondary: 'bg-emerald-200' },
    { id: 'slate', name: 'Teal & Mint', primary: 'bg-teal-500', secondary: 'bg-emerald-200' },
    { id: 'teal', name: 'Teal & Mint', primary: 'bg-teal-500', secondary: 'bg-emerald-200' },
  ];
